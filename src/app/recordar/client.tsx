...
export default function RecordarClient() {
  ...
  function evaluar() {
    ...
    const faltantes = faltantesNorm.map((n) => objetivo[objetivoNorm.indexOf(n)]);
    ...
    return (
      <div className="font-sans min-h-screen p-8 sm:p-12 flex items-center justify-center">
        <main className="w-full max-w-3xl space-y-6 text-center">
          ...
          <p className="text-[15px] text-muted-foreground">Vuelve al inicio para configurar una sesión.</p>
          <div>
            <Button asChild>
        ...
        <section className="rounded-xl border p-6 sm:p-8 bg-card text-card-foreground shadow-sm space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <Button variant="link" asChild>
              <Link href="/">Nueva configuración</Link>
            </Button>
          </div>
